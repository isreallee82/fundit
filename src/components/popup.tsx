...
const Popup = (props: any) => {
  return (
    <div className='xs:fixed md:w-2/5 md:top-28 z-40 xs:bottom-14 md:right-0 md:right-36 p-4 sm:w-4/5 xs:w-full md:h-1/5 rounded-3xl bg-stone-100 bg-opacity-60 backdrop-filter backdrop-blur-lg '>
