...
const Popup = (props: any) => {
  return (
    <div className='xs:fixed md:w-2/6 md:top-28 z-40 xs:bottom-14 md:right-0 md:right-36 p-2 sm:w-2/6 xs:w-full md:h-max rounded-3xl bg-stone-300 bg-opacity-60 backdrop-filter backdrop-blur-lg '>
