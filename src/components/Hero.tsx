...
const Hero = () => {
  return (
    <div className='mx-auto items-center justify-center flex lg:flex-row md:flex-col xs:flex-col w-full  bg-slate-200 md:my-24 lg:my-24 xs:my-24  hero'>
      <div className='lg:ml-12 lg:pl-12 flex lg:my-16 md:flex-col xs:flex-col lg:w-1/2 md:w-full md:justify-center xs:w-full md:h-full lg:p-4'>
        ...
        <div className='flex gap-8 justify-center lg:flex-row md:flex-row m-8 md:p-2 lg:text-lg md:text-base xs:mb-4 '>
          <button className='rounded-3xl hover:bg-stone-400 px-4 py-2 bg-stone-600 text-white text-center '>
            Connect
          </button>
          <button className='rounded-sm px-4 py-2  hover:bg-stone-600 bg-stone-400 text-center text-white '>
            Explore
          </button>
        </div>
      </div>
